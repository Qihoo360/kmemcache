  ...
  const u32    initval)   /* initval */
{
  ...
  if (HASH_LITTLE_ENDIAN && ((u.i & 0x3) == 0)) {
    const u32 *k = key;                           /* read 32-bit chunks */
#ifdef VALGRIND
    const u8  *k8;
    ...
    const u16 *k = key;                           /* read 16-bit chunks */
    const u8  *k8;
    ...
    case 12: c+=k[4]+(((u32)k[5])<<16);
             ...
             a+=k[0]+(((u32)k[1])<<16);
             break;
    case 11: c+=((u32)k8[10])<<16;     /* @fallthrough */
    ...
    case 8 : b+=k[2]+(((u32)k[3])<<16);
             a+=k[0]+(((u32)k[1])<<16);
             break;
    case 7 : b+=((u32)k8[6])<<16;      /* @fallthrough */
    case 6 : b+=k[2];
             a+=k[0]+(((u32)k[1])<<16);
             break;
    ...
    case 4 : a+=k[0]+(((u32)k[1])<<16);
             break;
    case 3 : a+=((u32)k8[2])<<16;      /* @fallthrough */
    case 2 : a+=k[0];
             break;
    case 1 : a+=k8[0];
             break;
